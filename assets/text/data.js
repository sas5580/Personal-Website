var data = {
	...
	projects: [
...

		{
			...
			description: "Developed with <b><i>C++</i></b>, <b><i>Python</i></b>, and various of its libraries such as <b><i>matplotlib</i></b> and <b><i>pyo</i></b>, and the <b><i>Myo armband API</i></b>, Myusicality is a DJ simulator program that allows the user to mix music, of their choice, live using intricate gestures with the Myo armband. The control the user has over the music as it is playing ranges from blocking specific amounts of the low frequencies all the way to the high frequencies and an parts in between. The program also has a graphical user interface using Python 2 that displays the levels of the frequencies of the music playing in real time.",			
